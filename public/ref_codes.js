...
class ListOfRefCodes extends React.Component {
	...
	render() {
		const listItems = this.state.list.map((listItem, index) => var  a = <RefListing key={listItem.recipientURL} listItem={listItem}/>; var b = (index == this.state.list.length-1) ? <br><span>****</span> : <br>; return a+b;);
